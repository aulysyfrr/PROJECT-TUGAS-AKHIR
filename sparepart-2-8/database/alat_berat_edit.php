...
<div class="container py-4" style="max-width:1000px">
    ...
    <div class="card">
        ...
        <form method="post" id="mainForm">
            ...
            <div class="section-title mt-3"><i class="bi bi-tools"></i> Operasional & Perbaikan</div>
...
// Root -> kategoriUmur === 'tua'? -> skorTampil <= 3? -> skorTampil <= 7?
...
function evaluasiPohonKeputusanRisiko(kategoriUmur, skorTampil) {
    const data = { kategoriUmur, skorTampil };
...
function predictRisiko() {
    ...
    const leaf = evaluasiPohonKeputusanRisiko(kategoriUmur, skorTampil);
